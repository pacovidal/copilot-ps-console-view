...
//   new CopilotWebview({ extensionName, contentDir, callbacks?, title?, width?, height?, iconPath? })
...
async function showWebview({ dir, title = "Copilot Webview", width = 900, height = 700, iconPath = null, callbacks = {} } = {}) {
...
export class CopilotWebview {
    constructor({ extensionName, contentDir, callbacks = {}, title, width, height, iconPath } = {}) {
